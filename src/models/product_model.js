...
export default class ProductModel {
  ...
  static update(productOj){
    const index =products.findIndex(p=> p.id==productOj.id);
    products[index]=productOj;
  }
  static delete(id){
...
export const products = [
  ...
  },
  {
    ...
    price: 15.99,
    desc:
      "The color could be slightly different between on the screen and in practice. / Please note that body builds vary by person, therefore, detailed size information should be reviewed below on the product desc.",
    category: "men's clothing",
